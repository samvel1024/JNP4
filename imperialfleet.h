...
static void attack(ImperialStarship<I> &ship1,
                   RebelStarship<R, true, min, max> &ship2) {
...
template <typename I, typename R, int min, int max>
static void attack(ImperialStarship<I> &ship1,
                   RebelStarship<R, false, min, max> &ship2) {
    ship2.takeDamage(ship1.getAttackPower());
}

template <typename I, typename R>
[[maybe_unused]] static void attack([[maybe_unused]] I &ship1,
                                    [[maybe_unused]] R &ship2) {}
